...
// This file was generated at 2022-03-10T14:39:33+01:00
...
var allLanguages = []Language{
	AAR, ABK, ACE, ACH, ADA, ADY, AFH, AFR, AIN, AKA, AKK, SQI, ALE, ALT, AMH, ANG, ANP, ARA, ARC, ARG,
	HYE, ARN, ARP, ARW, ASM, AST, AVA, AVE, AWA, AYM, AZE, BAK, BAL, BAM, BAN, EUS, BAS, BEJ, BEL, BEM,
	BEN, BHO, BIK, BIN, BIS, BLA, BOS, BRA, BRE, BUA, BUG, BUL, MYA, BYN, CAD, CAR, CAT, CEB, CHA, CHB,
	CHE, CHG, ZHO, CHK, CHM, CHN, CHO, CHP, CHR, CHU, CHV, CHY, CNR, COP, COR, COS, CRE, CRH, CSB, CES,
	DAK, DAN, DAR, DEL, DEN, DGR, DIN, DIV, DOI, DSB, DUA, DUM, NLD, DYU, DZO, EFI, EGY, EKA, ELX, ENG,
	ENM, EPO, EST, EWE, EWO, FAN, FAO, FAT, FIJ, FIL, FIN, FON, FRA, FRM, FRO, FRR, FRS, FRY, FUL, FUR,
	GAA, GAY, GBA, KAT, DEU, GEZ, GIL, GLA, GLE, GLG, GLV, GMH, GOH, GON, GOR, GOT, GRB, GRC, ELL, GRN,
	GSW, GUJ, GWI, HAI, HAT, HAU, HAW, HEB, HER, HIL, HIN, HIT, HMN, HMO, HRV, HSB, HUN, HUP, IBA, IBO,
	ISL, IDO, III, IKU, ILE, ILO, INA, IND, INH, IPK, ITA, JAV, JBO, JPN, JPR, JRB, KAA, KAB, KAC, KAL,
	...
	LUA, LUB, LUG, LUI, LUN, LUO, LUS, MKD, MAD, MAG, MAH, MAI, MAK, MAL, MAN, MRI, MAR, MAS, MSA, MDF,
	MDR, MEN, MGA, MIC, MIN, MLG, MLT, MNC, MNI, MOH, MON, MOS, MUL, MUS, MWL, MWR, MYV, AQP, NAP, NAU,
	NAV, NBL, NDE, NDO, NDS, NEP, NEW, NIA, NIU, NNO, NOB, NOG, NON, NOR, NQO, NSO, NWC, NYA, NYM, NYN,
	NYO, NZI, OCI, OJI, ORY, ORM, OSA, OSS, OTA, PAG, PAL, PAM, PAN, PAP, PAU, PEO, FAS, PHN, PLI, POL,
	PON, POR, PRO, PUS, QUE, RAJ, RAP, RAR, ROH, ROM, RON, RUN, RUP, RUS, SAD, SAG, SAH, SAM, SAN, SAS,
	SAT, SCN, SCO, SEL, SGA, SHN, SID, SIN, SLK, SLV, SMA, SME, SMJ, SMN, SMO, SMS, SNA, SND, SNK, SOG,
	SOM, SOT, SPA, SRD, SRN, SRP, SRR, SSW, SUK, SUN, SUS, SUX, SWA, SWE, SYC, TAH, TAM, TAT, TEL, TEM,
	TER, TET, TGK, TGL, THA, BOD, TIG, TIR, TIV, TKL, TLH, TLI, TMH, TOG, TON, TPI, TSI, TSN, TSO, TUK,
	TUM, TUR, TVL, TWI, TYV, UDM, UGA, UIG, UKR, UMB, UND, URD, UZB, VAI, VEN, VIE, VOL, VOT, WAL, WAR,
	WAS, CYM, WLN, WOL, XAL, XHO, YAO, YAP, YID, YOR, ZAP, ZBL, ZEN, ZHA, ZUL, ZUN, ZXX, ZZA,
}
